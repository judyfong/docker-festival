...
../$INST_$LANG_$VOX_16k/unpack.sh wav 2>wav/unpack.log
...
#cp -p ../$INST_$LANG_$VOX_text/txt.done.data etc/
#
# Or it could be a subset of prompts from a single session,
# e.g. the first 10:
fgrep 000 ../$INST_$LANG_$VOX_text/txt.done.data > etc/txt.done.data
#
